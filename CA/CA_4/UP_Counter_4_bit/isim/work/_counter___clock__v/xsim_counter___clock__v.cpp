...
va_list vap)
{
    extern HSim__s6 * createworkM_counter___clock__v(const char*);
    HSim__s6 *blk = createworkM_counter___clock__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","Counter_Clock_v", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_counter___clock__v(const char*);
        topvl = (HSim__s5*)createworkM_counter___clock__v("Counter_Clock_v");
