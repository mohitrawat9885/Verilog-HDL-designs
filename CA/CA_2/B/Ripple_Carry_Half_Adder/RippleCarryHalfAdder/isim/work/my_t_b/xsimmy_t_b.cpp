...
va_list vap)
{
    extern HSim__s6 * createworkMmy_t_b(const char*);
    HSim__s6 *blk = createworkMmy_t_b(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkM_half___adder(const char*);
    HSim__s6 *blk = createworkM_half___adder(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkM_full___adder(const char*);
    HSim__s6 *blk = createworkM_full___adder(label); 
    return blk;
}
