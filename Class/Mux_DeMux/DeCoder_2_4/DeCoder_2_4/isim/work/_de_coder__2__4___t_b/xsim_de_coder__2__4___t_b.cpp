...
va_list vap)
{
    extern HSim__s6 * createworkM_de_coder__2__4___t_b(const char*);
    HSim__s6 *blk = createworkM_de_coder__2__4___t_b(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkM_de_coder__2__4(const char*);
    HSim__s6 *blk = createworkM_de_coder__2__4(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","DeCoder_2_4_TB", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("work","DeCoder_2_4", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_de_coder__2__4___t_b(const char*);
        topvl = (HSim__s5*)createworkM_de_coder__2__4___t_b("DeCoder_2_4_TB");
