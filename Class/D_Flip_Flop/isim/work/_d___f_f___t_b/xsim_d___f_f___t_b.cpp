...
va_list vap)
{
    extern HSim__s6 * createworkM_d___f_f___t_b(const char*);
    HSim__s6 *blk = createworkM_d___f_f___t_b(label); 
    return blk;
}
